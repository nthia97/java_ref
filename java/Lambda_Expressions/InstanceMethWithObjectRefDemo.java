// Use an instance method reference with diferrent objects
//
...
class HighTemp{
	...
	// Return true if the invoking HighTemp object has the
	// same tempeature as ht2
...
class InstanceMethWithObjectsRefDemo {
